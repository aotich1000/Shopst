...
if(product.length==0){
  let ProductArray = [
    ...
    { productId: 51, category: '3', img: 'Bộ đồ chơi cho mèo 170k.PNG', nameP: 'Bộ đồ chơi cho mèo', price: 6},
    { productId: 52, category: '4', img: 'Bóng Cao Su Đồ Chơi Cho Chó Mèo Hình Mặt Cún Đáng Yêu 45k.PNG', nameP: 'Bóng Cao Su Đồ Chơi Cho Chó ', price: 2},
    { productId: 53, category: '3', img: 'Đồ chơi cần câu cán nhựa cho mèo 25k.PNG', nameP: 'Đồ chơi cần câu cán nhựa', price: 1},
    { productId: 54, category: '4', img: 'Đồ chơi cho chó cắn gặm hình đùi gà phát âm thanh 30k.PNG', nameP: 'Đùi gà phát âm thanh ', price: 1.5},
    { productId: 55, category: '4', img: 'Đồ chơi cho chó đùi gà vải Cutepets.PNG', nameP: 'Đồ chơi cho chó đùi gà vải', price: 2},
    { productId: 56, category: '3', img: 'Đồ Chơi Tháp Banh 4 Tầng Cho Mèo 109k.PNG', nameP: 'Đồ Chơi Tháp Banh 4 Tầng Cho Mèo', price: 5},
    { productId: 57, category: '3', img: 'Đồ Chơi Trụ Cào Móng Có Bóng Treo Cho Mèo 59k.PNG', nameP: 'Trụ Cào Móng Có Bóng Treo', price: 3},
    { productId: 58, category: '4', img: 'ĐÙI GÀ ĐỒ CHƠI NHAI GẶM CHO THÚ CƯNG.PNG', nameP: 'Đùi gà gặm cho thú cưng', price: 2},
    { productId: 59, category: '3', img: 'NEKKO JELLY (70g) Pate Cho Mèo Trưởng Thành Vị Cá Ngừ Nhiều Topping 12k.PNG', nameP: 'NEKKO JELLY (70g) ', price: 1},
    { productId: 60, category: '4', img: 'Pate Cho Chó Pedigree Vị Gà, Gan và Rau Củ 18k.PNG', nameP: 'Pate Cho Chó Pedigree', price: 1},
    { productId: 61, category: '4', img: 'Pate cho chó Royal Canin Medium Puppy 140g 410k.PNG', nameP: 'Royal Canin Medium Puppy 140g', price: 21},
    { productId: 62, category: '4', img: 'Pate chó Mckelly 400g 55k.PNG', nameP: 'Pate chó Mckelly 400g', price: 2},
    { productId: 63, category: '3', img: 'Pate cho mèo Catchy cá ngừ và cá hồi trong thạch 15k.PNG', nameP: 'Pate cho mèo Catchy', price: 1},
    { productId: 64, category: '3', img: 'Pate cho mèo Ciao 60g 10k.PNG', nameP: 'Pate cho mèo Ciao 60g', price: 1},
    { productId: 65, category: '3', img: 'Pate Cho Mèo Con Whiskas Vị Cá Ngừ 12k.PNG', nameP: 'Pate Cho Mèo Con Whiskas Vị Cá Ngừ', price: 1},
    { productId: 66, category: '3', img: 'Pate Cho Mèo Lớn Whiskas 1+ 10k.PNG', nameP: 'Pate Cho Mèo Lớn Whiskas 1+', price: 1},
    { productId: 67, category: '3', img: 'Pate cho mèo thức ăn mèo dạng mềm thức ăn thưởng cho mèo mọi lứa tuổi-170g  30k.PNG', nameP: 'Pate cho mèo thức ăn mèo dạng mềm', price: 3},
    { productId: 68, category: '4', img: 'Pedigree - Patê cho chó con 400g 48k.PNG', nameP: 'Pedigree - Patê cho chó con 400g', price: 3},
    { productId: 69, category: '3', img: 'Royal canin kitten - Thức ăn cho mèo từ 4-12 tháng tuổi 400gr 120k.PNG', nameP: 'Royal canin kitten 400gr', price: 5},
    { productId: 70, category: '4', img: 'Thức Ăn Cho Chó Classic Vị Thịt Bò & Sữa Hạt Khô 400g  69k.PNG', nameP: 'Thức Ăn Cho Chó Classic 400g', price: 3},
    { productId: 71, category: '3', img: 'Thức Ăn Cho Mèo Me-O Tuna Adult 1.2kg 125k.PNG', nameP: 'Me-O Tuna Adult 1.2kg', price: 4},
    { productId: 72, category: '3', img: 'Thức ăn hạt cho mèo mọi lứa tuổi CATSRANG - 2kg 270k.PNG', nameP: 'Thức ăn hạt CATSRANG - 2kg', price: 9},
    { productId: 73, category: '4', img: 'Thức ăn hạt mềm cho chó già Zenith 1.2kg - Hàn Quốc 77k.PNG', nameP: 'Thức ăn hạt mềm cho chó già Zenith', price: 3},
    { productId: 74, category: '4', img: 'Thức ăn hạt mềm cho chó giống nhỏ Zenith 300g - Hàn Quốc 66k.PNG', nameP: 'Thức ăn hạt mềm cho chó nhỏ Zenith 300g', price: 3},
    { productId: 75, category: '3', img: 'THỨC ĂN HẠT WHISKAS CHO MÈO 130k.PNG', nameP: 'Thức ăn hạt Whiskas cho mèo', price: 4},
  ];
